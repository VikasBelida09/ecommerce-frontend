...
import vcom from '../assets/VCOM.png'
import { userRequest } from '../requestMethods';
import { useHistory } from 'react-router-dom';
const STRIPE_PUBLIC_KEY = process.env.STRIPE_PUBLIC_KEY || 'pk_test_ZUAVbSLbw89ozJhCnYh5Uihh006t3vu8zB'
    ...
    const makePayment=async ()=>{
      try {
        ...
        const res = await userRequest.post("/orders", {
          ...
          address: resp.data.billing_details.address,
        });
        history.push('/success',{orderId:res.data._id});
      } catch (error) {
